...
namespace project3
{
    public partial class Form1 : Form
    {
        ...
        bool drawFlg = false;   //true : ï`âÊíÜ   
        ...
        private void draw(Graphics g, Point xy1, Point xy2)
        {
            ...
            bool drawX = true;  //true : Xé≤äÓèÄÇ≈ï`âÊ
                                //false : Yé≤äÓèÄÇ≈ï`âÊ

            if (Math.Abs(xy2.X - xy1.X) > Math.Abs(xy2.Y - xy1.Y))
            {
                //ïùÇÃï˚Ç™ëÂÇ´Ç¢èÍçá->Xé≤Ç≈ÉãÅ[Év
                //xy2ÇÃxÇ™ëÂÇ´Ç≠Ç»ÇÈÇÊÇ§Ç…èàóù
                if (xy1.X > xy2.X)
                {
                    Point p = xy1;
                    xy1 = xy2;
            ...
            {
                //çÇÇ≥ÇÃï˚Ç™ëÂÇ´Ç¢èÍçá->Yé≤Ç≈ÉãÅ[Év
                //xy2ÇÃyÇ™ëÂÇ´Ç≠Ç»ÇÈÇÊÇ§Ç…èàóù
                if (xy1.Y > xy2.Y)
                {
                    Point p = xy1;
                    xy1 = xy2;
